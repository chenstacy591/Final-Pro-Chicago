...
domvio_mod <- glm(isdomviolence ~ pandemic_time+as.factor(is9_5), data = domvio_mut, 
                  family = "binomial")
...
lower_pl <- exp(odds_prelockdown - (cm*se_prelockdown))
upper_pl <- exp(odds_prelockdown + (cm*se_prelockdown))
lower_pl
upper_pl

#95% CI for odds ratio for lockdown
se_lockdown <- 0.024
lower_l <- exp(odds_lockdown - (cm*se_lockdown))
upper_l <- exp(odds_lockdown + (cm*se_lockdown))
lower_l
upper_l

#95% CI for odds ratio for phase 2
se_p2 <- 0.025
lower_p2 <- exp(odds_phase2 - (cm*se_p2))
upper_p2 <- exp(odds_phase2 + (cm*se_p2))
lower_p2
upper_p2

#95% CI for odds ratio for phase 3
se_p3 <- 0.028
lower_p3 <- exp(odds_phase3 - (cm*se_p3))
upper_p3 <- exp(odds_phase3 + (cm*se_p3))
lower_p3
upper_p3

#95% CI for odds ratio for phase 4
se_p4 <- 0.035
lower_p4 <- exp(odds_phase4 - (cm*se_p4))
upper_p4 <- exp(odds_phase4 + (cm*se_p4))
lower_p4
upper_p4
