...
domvio<-domvio %>%
  ...
  mutate(DATEINT = as.integer(paste(YEAR, MONTH, DAY, sep=""))) %>%
...
```{r domestic-vs-time}
table(domvio_mut$DATEINT, domvio_mut$isdomviolence)
```
...
H0 : The frequency of domestic violence cases in Chicago is unrelated to the phases of the pandemic.
H1 : The frequency of domestic violence cases in Chicago is related to the phases of the pandemic.
...
.05/3
```
We found that all three pairwise difference in proportions are significant at the adjusted siginficance level.
